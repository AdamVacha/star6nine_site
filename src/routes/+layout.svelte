		...
		<div class="container mx-auto px-4">
			...
			>
				...
				<div class="flex space-x-6">
					...
					<!-- Bandcamp -->
					<a
						href="https://star6nine.bandcamp.com/"
						class="hover:text-primary-400 text-white transition-colors flex items-center"
						aria-label="Bandcamp"
						target="_blank"
						rel="noopener noreferrer"
					>
						<img
							src="/lib/assets/footer-icons/bandcamp-button-bc-circle-white-32.png"
							alt="Bandcamp"
							class="h-6 w-6"
						/>
					</a>
